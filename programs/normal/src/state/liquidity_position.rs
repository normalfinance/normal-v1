...
use super::{ amm::AMM, market::Market, Tick };
...
impl LiquidityPosition {
	...
	pub fn open_position(
		...
		if
			!Tick::check_is_usable_tick(tick_lower_index, amm.amm.tick_spacing) ||
			!Tick::check_is_usable_tick(tick_upper_index, amm.amm.tick_spacing) ||
		...
		if amm.amm.tick_spacing >= FULL_RANGE_ONLY_TICK_SPACING_THRESHOLD {
			let (full_range_lower_index, full_range_upper_index) =
				Tick::full_range_indexes(amm.amm.tick_spacing);
			if
