...
impl<'a> MarketMap<'a> {
    ...
    #[track_caller]
    #[inline(always)]
    pub fn get_ref_mut(&self, market_index: &u16) -> NormalResult<RefMut<Market>> {
    ...
    pub fn load<'b, 'c>(
        ...
        let mut market_map: MarketMap =
            MarketMap(BTreeMap::new(), writable_markets.clone());
...
pub fn get_writable_market_set_from_many(market_indexes: Vec<u16>) -> MarketSet {
    let mut writable_markets = MarketSet::new();
