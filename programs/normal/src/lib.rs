...
pub mod normal {
	...
	pub fn collect_fees_v2<'info>(
		...
		handle_collect_fees_v2(ctx, remaining_accounts_info)
	}
	...
	pub fn collect_protocol_fees_v2<'info>(
		...
		handle_collect_protocol_fees_v2(ctx, remaining_accounts_info)
	}
	...
	pub fn collect_reward_v2<'info>(
		...
		handle_collect_reward_v2(ctx, reward_index, remaining_accounts_info)
	}
