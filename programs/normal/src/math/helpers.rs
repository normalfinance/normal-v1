...
pub fn get_proportion_i128(value: i128, numerator: u128, denominator: u128) -> NormalResult<i128> {
...
pub fn get_proportion_u128(value: u128, numerator: u128, denominator: u128) -> NormalResult<u128> {
...
pub fn on_the_hour_update(now: i64, last_update_ts: i64, update_period: i64) -> NormalResult<i64> {
