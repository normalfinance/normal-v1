...
pub fn get_oracle_status(
    ...
    let oracle_reserve_price_spread_pct = amm::calculate_oracle_twap_5min_price_spread_pct(
        &market.amm,
        reserve_price
    )?;
...
pub fn oracle_validity(
    ...
    if log_validity {
        if !has_sufficient_number_of_data_points {
            msg!("Invalid {} {} Oracle: Insufficient Data Points", market_type, market_index);
        }
