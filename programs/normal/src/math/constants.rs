...
pub const EMERGENCY_SHUTDOWN_PAUSED_OPERATIONS: u8 = 0b00101011;

// SPOT MARKET CONSTANTS
pub const QUOTE_SPOT_MARKET_INDEX: u16 = 0;

// USER ACCOUNT CONSTANTS
pub const MAX_COLLATERAL_POSITIONS: u8 = 8;
...
pub const BID_ASK_SPREAD_PRECISION_U128: u128 =
	BID_ASK_SPREAD_PRECISION as u128; // expo = -6
pub const BID_ASK_SPREAD_PRECISION_I128: i128 =
	BID_ASK_SPREAD_PRECISION as i128; // expo = -6
...
pub const LIQUIDATION_FEE_PRECISION_U128: u128 =
	LIQUIDATION_FEE_PRECISION as u128; // expo = -6
...
pub const AMM_TO_QUOTE_PRECISION_RATIO: u128 =
	AMM_RESERVE_PRECISION / QUOTE_PRECISION; // expo: 3
...
pub const PRICE_TO_QUOTE_PRECISION_RATIO: u128 =
	PRICE_PRECISION / QUOTE_PRECISION; // expo: 1
...
// QUOTE AMOUNTS
pub const ONE_HUNDRED_MILLION_QUOTE: u64 =
	100_000_000_u64 * QUOTE_PRECISION_U64;
...
pub const TWO_HUNDRED_FIFTY_THOUSAND_QUOTE: u64 =
	250_000_u64 * QUOTE_PRECISION_U64;
...
// QUOTE THRESHOLDS
pub const FEE_POOL_TO_REVENUE_POOL_THRESHOLD: u128 =
	TWO_HUNDRED_FIFTY_QUOTE as u128;

// FEES
pub const ONE_BPS_DENOMINATOR: u32 = 10000;
pub const MAX_REFERRER_REWARD_EPOCH_UPPER_BOUND: u64 = (4000 *
...
pub const MAX_APR_PER_REVENUE_SETTLE_TO_INSURANCE_FUND_VAULT: u64 =
	10 * PERCENTAGE_PRECISION_U64; // 1000% APR

pub const MAX_CONCENTRATION_COEFFICIENT: u128 = 1_414_200;
pub const MAX_LIQUIDATION_MULTIPLIER: u32 = 3;
pub const LIQUIDATION_FEE_INCREASE_PER_SLOT: u32 =
	LIQUIDATION_FEE_PRECISION / 1_000_000; // .01 bps per slot
...
pub const MAX_BID_ASK_INVENTORY_SKEW_FACTOR: u64 =
	10 * BID_ASK_SPREAD_PRECISION;

pub const MAX_POSITIVE_UPNL_FOR_INITIAL_MARGIN: i128 =
	100 * QUOTE_PRECISION_I128; // max upnl for initial margin calc
...
pub const TRANSFER_MEMO_COLLECT_PROTOCOL_FEES: &str =
	"Normal CollectProtocolFees";
pub const TRANSFER_MEMO_COLLECT_FEES: &str = "Normal CollectFees";
pub const TRANSFER_MEMO_COLLECT_REWARD: &str = "Normal CollectReward";
pub const TRANSFER_MEMO_DECREASE_LIQUIDITY: &str = "Normal Withdraw";
pub const TRANSFER_MEMO_SWAP: &str = "Normal Trade";
