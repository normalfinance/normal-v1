...
pub fn update_user_stats_if_stake_amount(
	...
	user_stats.if_staked_asset_amount = if_stake_amount;
...
pub fn apply_rebase_to_insurance_fund_stake(
	...
	if insurance_fund.shares_base != insurance_fund_stake.if_base {
		...
		insurance_fund_stake.update_if_shares(new_if_shares, insurance_fund)?;
...
pub fn transfer_protocol_insurance_fund_stake(
	...
	// 	user_stats.if_staked_asset_amount = if_shares_to_vault_amount(
...
// 	if insurance_fund.revenue_settle_period == 0 {
...
// 	if insurance_fund.user_shares > 0 {
...
// 			.safe_div(
// 				ONE_YEAR.safe_div(
// 					insurance_fund.revenue_settle_period.cast()?
// 				)?.max(1)
// 			)?;
...
// 	let protocol_if_factor = insurance_fund.total_factor.safe_sub(
// 		insurance_fund.user_factor
// 	)?;
